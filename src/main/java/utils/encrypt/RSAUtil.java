...
public class RSAUtil extends BASE64Util {
    ...
    public String encryptData(Object data) throws Exception {
        ...
        byte[] targetByte = encryptByPrivateKey(sourceData.getBytes(), privateKey);
    ...
    public String decryptData(String data) throws Exception {
        byte[] targetByte = decryptByPrivateKey(decryptBASE64(data), privateKey);
        return new String(targetByte);
    }
     ...
     * @throws Exception
     */
    private byte[] decryptByPublicKey(byte[] data, String key)
            throws Exception {
        // 对密钥解密
        byte[] keyBytes = decryptBASE64(key);
     ...
     * @throws Exception
     */
    private byte[] encryptByPublicKey(byte[] data, String key)
            throws Exception {
        // 对公钥解密
        byte[] keyBytes = decryptBASE64(key);
     ...
     * @throws Exception
     */
    private byte[] encryptByPrivateKey(byte[] data, String key)
            throws Exception {
        // 对密钥解密
        byte[] keyBytes = decryptBASE64(key);
    ...
    private Map<String, Object> initKey() throws Exception {
        ...
        Map<String, Object> keyMap = MapUtils.newHashMap();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, Object> stringObjectMap = rsaUtil.initKey();
        ...
        RSAUtil rsaUtil = new RSAUtil();
        byte[] bytes = rsaUtil.encryptByPublicKey("u06csMYzhU3ojX5koBf28g==".getBytes(), "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCB9/oWXLw6HpM1JeEBCBj+5t63d0B3AHFBBYCrES8KHRHPDIrJ9h5aM10OT4RCXMJ5A+2ycShYNoPLj8RoefBeTLe7KeYVuwz2FPqTBu3eqZkkDMuB9Bt6NZUNkNXDqmIK8eO56e653fqmWJfOUjzWh2JGj/mCcTXDKjbakViSZQIDAQAB");
